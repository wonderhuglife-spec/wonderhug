  ...
  return (
    <section className="py-20">
      <Container className="grid overflow-hidden rounded-[2rem] border border-line bg-white lg:grid-cols-2">
        <Media src="/images/placeholder-ai-program-parenting.png" alt="placeholder-ai- Daily companion atmosphere." className="min-h-[16rem] w-full object-cover" width={900} height={700} />
