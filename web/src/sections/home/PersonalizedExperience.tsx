    ...
    <section className="py-8">
      <Container>
        <div className="grid overflow-hidden rounded-[2rem] bg-navy text-white lg:grid-cols-2">
          <HoverMedia src="/images/placeholder-ai-hero-home.png" alt="An expecting couple in a sunlit family living room." className="min-h-[16rem] w-full lg:min-h-full" width={960} height={720} />
